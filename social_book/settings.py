...
SECRET_KEY = 'django-insecure-s-ocrh+^a*g#z8oy!6sp+-#0z2u%q@-)+$(n)br&17s(a_2ve='
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # Ensure this includes your templates directory
        ],
        'APP_DIRS': True,  # Ensures templates are loaded from app-specific directories
        'OPTIONS': {
            'context_processors': [
